...
class figure_8_estimator():
    def __init__(self):
        ...
        self.new_target_position_data = False
        ...
        # Subscribers
        self.target_position_sub = rospy.Subscriber("reconstructXYZ/world/position_mv", PointStamped, self.target_position_callback)
    ...
    def target_position_callback(self, data):
        self.new_target_position_data = True
        self.target_position_data = data
    ...
    def run(self, rate):
        ...
        while not rospy.is_shutdown():
            if (self.start_estimator):
                ...
                if self.new_target_position_data:

                    if self.check_inside_2d(self.target_position_data.point) or self.disable_boundary_check:
                        ...
                        if (not self.estimator_state):
                            self.estimatefigure8(self.target_position_data)
                    else:
                    ...
                    self.uav_position_publisher.publish(self.target_position_data)
